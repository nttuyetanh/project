...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first" style="height: 30px;">
      ...
      <h3 style="margin-top: 30px">ĐĂNG KÝ</h3>
    </div>
    <?php
        if(isset($_POST['addNew'])){
            ...
            if($_POST['password']!=$_POST['password2']){
                ...
                if($result_select_user->rowCount()<=0){ //email chua ton tai
                    $query = "INSERT INTO user VALUES('','$user_name','$email','$password','$mobile','$date_create')";
                    if($conn->query($query)){
                        $_SESSION['new_register'] = $email;
    ...
    <form action="" method="POST"> 
      ...
      <input type="text" id="login" class="fadeIn second" name="phone" placeholder="Phone" required>
      <input type="password" id="login" class="fadeIn second" name="password" placeholder="Password" required>
      <input type="password" id="login" class="fadeIn second" name="password2" placeholder="Password Confirm" required>
      <input type="submit" name="addNew" class="fadeIn fourth" value="Đăng ký">
    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a href="login.php" class="underlineHover" href="#">Đăng nhập</a>
    </div>
