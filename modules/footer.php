    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 pt-5">
                <h2 class="h2 text-success border-bottom pb-3 border-light logo">Panacea</h2>
                <ul class="list-unstyled text-light footer-link-list">
                    <li>
                        <i class="fas fa-map-marker-alt fa-fw"></i>
                        17T đường Nguyễn Văn Linh, phường Hưng Lợi, quận Ninh Kiều, Cần Thơ
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a class="text-decoration-none" href="mailto:panacea@gmail.com">panacea@gmail.com</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-5">
                ...
                ?>
                    ...
                    <li>
                        <a class="text-decoration-none" href="index.php?page=category&cat_id=<?php echo $rowCat["cat_id"] ?>"><?php echo $rowCat["cat_name"] ?></a>
                    </li>
                <?php } } ?>
                </ul>
            </div>
